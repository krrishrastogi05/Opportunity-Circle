    ...
    <article className="max-w-3xl mx-auto px-4 sm:px-6 pt-10 pb-20">
      ...
      <header className="mb-10">
        <div className="flex items-center gap-4 mb-5">
          <div className="w-14 h-14 rounded-2xl bg-[#FC8019] flex items-center justify-center shrink-0">
            <span style={{ color: "#fff", fontSize: 26, fontWeight: 800, fontFamily: "sans-serif" }}>S</span>
          </div>
          <div>
